...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3"><p align="center">&nbsp;</p>      
      ...
      <form action="staff.php" method="post" enctype="multipart/form-data" name="admindes">
        <tr>
          <td colspan="2" align="center"><img src="images/aboutus.png" alt="" width="209" height="75" style="margin-right:-60px;" /></td>
          </tr>
        <tr>
        ...
        <tr>
          <td colspan="3" align="center"><strong><a href="stfregister.php" style="color:rgb(153,153,255); text-decoration:none">Register</a></strong></td>
        </tr>
          </form>
      </table>
      <p align="center">&nbsp;</p></td>
...
$pass=$_POST['pword'];
$sql="select * from staff_register where reg_uname='$uname' and reg_pword ='$pass'";
//echo $sql;
//exit;
$fre=mysql_query($sql);
